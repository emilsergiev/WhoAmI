...
public class QuestionsAndAnswer {
	...
	public QuestionsAndAnswer() {
		...
		questionsAndAnswers[3][0] = "How many people are in the room?";
		...
		questionsAndAnswers[4][4] = "September 1";
		...
		questionsAndAnswers[5][4] = "orange";
		...
		questionsAndAnswers[7][4] = "coffee";
		...
		questionsAndAnswers[8][4] = "Leonardo da Vinci";
		...
		questionsAndAnswers[9][4] = "water spill on the floor";
		...
		questionsAndAnswers[10][4] = "I saw myself in the mirror";
		...
		questionsAndAnswers[11][4] = "Later equals never";
		...
		questionsAndAnswers[12][4] = "A USB flash drive";
