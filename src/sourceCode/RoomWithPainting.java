...
public class RoomWithPainting extends JFrame {

	final JFXPanel jfxPanel;
	/**
	 * Create a new Frame, set title, ...
	 */
	public RoomWithPainting() {

		this.setTitle("Room With Painting");
	...
	private Scene initScene() {
		...
		final File f = new File("C:/Users/N/workspace/WhoAmI/src/media/03.roomWithPainting.mp4");
